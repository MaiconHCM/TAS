...
export class VendedorComponent implements OnInit {
  ...
  public displayedColumns: string[] = ['codigo','nome','cpf','email', 'endereco','saldoflex', 'ativo', 'options'];
  ...
  constructor(private service: VendedorService,private clienteService: ClienteService, private snakBar: MatSnackBar,
   ...
   * @param vendedor 
   */
  private openSidenav(vendedor: VendedorEntity): void {
  ...
  /**
   * Abre o formulário com um novo vendedor para inclusão
   */
  public adicionar(): void {
    this.openSidenav(new VendedorEntity());
  }
  ...
  public editar(vendedor: VendedorEntity): void {
    this.openSidenav(Object.assign({},vendedor));
  }
  ...
  public excluir(vendedor: VendedorEntity): void {
    ...
    dialogRef.afterClosed().subscribe(result => {
      ...
      if (result) {
        ...
        this.service.excluir(vendedor.id).subscribe(result => {
  ...
  public confirmar(): void {
    ...
    this.service.salvar(this.vendedor).subscribe(result => {
